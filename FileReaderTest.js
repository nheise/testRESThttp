...
var runner = require( './UnitTestRunner.js' ).create( new FileReaderTest() );
...
function FileReaderTest() {
    ...
    this.tests[0] = function readFromPositionToPositionMustReturnTheContentInGivenRange() {
...
//        callee.verfiy();
        ...
        var errorCallback = function( err ) {
            assert.fail( err, err,
                         "readFromPositionToPosition should not fail." );
        };
        ...
        fileReader.readFromPositionToPosition( FILE_PATH, range.begin,
                                               range.end );

    };

    function callReadWithoutRangeShouldReadTheHoleFile() {
